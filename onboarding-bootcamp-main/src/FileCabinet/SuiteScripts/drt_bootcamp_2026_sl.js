  ...
  const onRequest = (scriptContext) => {
    ...
    try {
      ...
      if (scriptContext.request.method === "GET") {
        ...
        const sublistData =
          scriptContext.request.parameters.sublistdata.split(delimiter);
        ...
        scriptContext.response.write(
          `You have entered: ${textField} ${dateField} ${currencyField} ${selectField} ${sublistField1} ${sublistField2}`,
        );
      }
    } catch (error) {
